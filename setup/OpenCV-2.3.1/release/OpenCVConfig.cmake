...
SET(OpenCV_INCLUDE_DIRS "/home/jharvard/Downloads/OpenCV-2.3.1/release" "/home/jharvard/Downloads/OpenCV-2.3.1/include" "/home/jharvard/Downloads/OpenCV-2.3.1/include/opencv")
...
SET(OpenCV_LIB_DIR /home/jharvard/Downloads/OpenCV-2.3.1/release/lib)
...
# ==============================================================
if(NOT "/home/jharvard/Downloads/OpenCV-2.3.1" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("/home/jharvard/Downloads/OpenCV-2.3.1/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("/home/jharvard/Downloads/OpenCV-2.3.1/release/3rdparty/lib")

    set(OpenCV_LIBS dl;m;pthread;rt   ${OpenCV_LIBS})
    set(OpenCV_EXTRA_COMPONENTS libjpeg libpng libtiff libjasper /usr/lib/libz.so)
